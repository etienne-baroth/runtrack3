...
formConnexion.addEventListener('submit', (e) => {
    ...
    if(data.email !== emailCo.value && data.password !== passwordCo.value) {
        let error = document.getElementById('connexionError')
...
// nom.setCustomValidity('Veuillez saisir un nom')
// prenom.setCustomValidity('Veuillez saisir un prénom')
// email.setCustomValidity('Veuillez rentrer un email')
// password.setCustomValidity('Veuillez rentrer un mot de passe')
// passwordConf.setCustomValidity('Veuillez confirmer le mot de passe')